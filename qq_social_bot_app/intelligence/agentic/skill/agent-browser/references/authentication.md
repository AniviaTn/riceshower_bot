...
登录流程、会话持久化、OAuth、2FA 和带认证的浏览。

**相关内容**：[session-management.md](session-management.md) 了解状态持久化详情，[SKILL.md](../SKILL.md) 了解快速入门。
...
# 验证登录成功
agent-browser get url  # 应该是仪表盘，而非登录页
```
